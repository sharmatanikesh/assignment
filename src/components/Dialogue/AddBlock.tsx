    ...
    import { X, User, Briefcase, GraduationCap, FolderKanban, Lightbulb, BookOpen, Award, FileCheck, Languages, Heart, Phone, Layout } from 'lucide-react';
    ...
    return (
        ...
        <DialogContent className="sm:max-w-[600px] lg:max-w-[700px] bg-white text-gray-900 shadow-lg max-h-[400px] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                ...
                <ButtonBox icon={<Briefcase className="h-4 w-4" />} text="Education" />
